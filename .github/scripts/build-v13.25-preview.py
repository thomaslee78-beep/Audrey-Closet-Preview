...
text = text.replace('</head>', style + '  <meta name="audrey-preview-build" content="v13.25-phase3-dev3-fix2">\n</head>', 1)
...
markers = (
    '<script src="./v13.25-phase1-journal-board.js?v=phase3-dev3-fix2"></script>\n'
    '  <script src="./v13.25-phase2-closet-log.js?v=phase3-dev3-fix2"></script>\n'
    '  <script src="./v13.25-phase3-contextual-journal.js?v=phase3-dev3-fix2"></script>\n'
    '  <script src="./v13.25-phase3-era-foundation.js?v=phase3-dev3-fix2"></script>\n'
    '  <script src="./v13.25-phase3-dev3-journal-experience.js?v=phase3-dev3-fix2"></script>\n'
    '  <script src="./v13.25-phase3-dev3-functional-fixes.js?v=phase3-dev3-fix2"></script>\n'
    '  <script src="./photo-studio-reopen-snapshot-hotfix-v13.24.js?v=phase3-dev3-fix2"></script>\n'
    '  <script src="./photo-studio-state-integrity-hotfix-v13.24.js?v=phase3-dev3-fix2"></script>\n'
    '  <script src="./v13.25-item-studio-context-fix.js?v=phase3-dev3-fix2"></script>'
)
...
checks = [
    'Add to Outfit Board',
    'audrey-preview-build" content="v13.25-phase3-dev3-fix2',
    'v13.25-phase1-journal-board.js?v=phase3-dev3-fix2',
    'v13.25-phase2-closet-log.js?v=phase3-dev3-fix2',
    'v13.25-phase3-contextual-journal.js?v=phase3-dev3-fix2',
    'v13.25-phase3-era-foundation.js?v=phase3-dev3-fix2',
    'v13.25-phase3-dev3-journal-experience.js?v=phase3-dev3-fix2',
    'v13.25-phase3-dev3-functional-fixes.js?v=phase3-dev3-fix2',
    'photo-studio-reopen-snapshot-hotfix-v13.24.js?v=phase3-dev3-fix2',
    'photo-studio-state-integrity-hotfix-v13.24.js?v=phase3-dev3-fix2',
    'v13.25-item-studio-context-fix.js?v=phase3-dev3-fix2',
]
for token in checks:
