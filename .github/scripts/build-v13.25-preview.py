...
text = text.replace('</head>', style + '  <meta name="audrey-preview-build" content="v13.25-phase3-dev3-layout51">\n</head>', 1)
...
markers='\n'.join('  <script src="./'+name+'?v=phase3-dev3-layout51"></script>' for name in names)
text = text.replace('</body>', cleanup + markers + '\n</body>', 1)
path.write_text(text, encoding='utf-8')

checks=['Add to Outfit Board','audrey-preview-build" content="v13.25-phase3-dev3-layout51','v13.25-phase3-journal-creative-page-refinements.js?v=phase3-dev3-layout51','v13.25-phase3-journal-sticker-interaction-polish.js?v=phase3-dev3-layout51','v13.25-phase3-journal-sticker-surface-v2.js?v=phase3-dev3-layout51','v13.25-phase3-journal-row-final.js?v=phase3-dev3-layout51','v13.25-phase3-journal-reader-refinements.js?v=phase3-dev3-layout51']
for token in checks:
