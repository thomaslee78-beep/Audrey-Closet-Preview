...
text = text.replace('</head>', style + '  <meta name="audrey-preview-build" content="v13.25-phase2-dev14">\n</head>', 1)
...
markers = (
    '<script src="./v13.25-phase1-journal-board.js?v=phase2-dev14"></script>\n'
    '  <script src="./v13.25-phase2-closet-log.js?v=phase2-dev14"></script>\n'
    '  <script src="./photo-studio-reopen-snapshot-hotfix-v13.24.js?v=phase2-dev14"></script>\n'
    '  <script src="./photo-studio-state-integrity-hotfix-v13.24.js?v=phase2-dev14"></script>\n'
    '  <script src="./v13.25-item-studio-context-fix.js?v=phase2-dev14"></script>'
)
...
checks = [
    'Add to Outfit Board',
    'audrey-preview-build" content="v13.25-phase2-dev14',
    'v13.25-phase1-journal-board.js?v=phase2-dev14',
    'v13.25-phase2-closet-log.js?v=phase2-dev14',
    'photo-studio-reopen-snapshot-hotfix-v13.24.js?v=phase2-dev14',
    'photo-studio-state-integrity-hotfix-v13.24.js?v=phase2-dev14',
    'v13.25-item-studio-context-fix.js?v=phase2-dev14',
]
for token in checks:
