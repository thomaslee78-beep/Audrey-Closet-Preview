...
text = text.replace('</head>', style + '  <meta name="audrey-preview-build" content="v13.25-phase3-dev3-layout21">\n</head>', 1)
...
names=[
'v13.25-phase1-journal-board.js','v13.25-phase2-closet-log.js','v13.25-phase3-contextual-journal.js','v13.25-phase3-era-foundation.js','v13.25-phase3-dev3-journal-experience.js','v13.25-phase3-dev3-functional-fixes.js','v13.25-phase3-dev3-journal-layout.js','v13.25-phase3-dev3-reader-polish-fix.js','v13.25-phase3-journal-title-log.js','v13.25-phase3-journal-detail-toolbar.js','v13.25-phase3-journal-row-polish2.js','v13.25-phase3-wear-log-detail-polish.js','v13.25-phase3-wear-log-layout2.js','v13.25-phase3-wear-log-interaction-fixes.js','v13.25-phase3-journal-editor-layout.js','v13.25-phase3-journal-editor-refinements.js','v13.25-item-studio-context-fix.js','photo-studio-reopen-snapshot-hotfix-v13.24.js','photo-studio-state-integrity-hotfix-v13.24.js']
for name in names:
    text = re.sub(r'\s*<script src="\./' + re.escape(name) + r'(?:\?[^\"]*)?"></script>\s*', '\n', text)

markers='\n'.join('  <script src="./'+name+'?v=phase3-dev3-layout21"></script>' for name in names)
text = text.replace('</body>', cleanup + markers + '\n</body>', 1)
path.write_text(text, encoding='utf-8')

checks=['Add to Outfit Board','audrey-preview-build" content="v13.25-phase3-dev3-layout21','v13.25-phase3-wear-log-layout2.js?v=phase3-dev3-layout21','v13.25-phase3-wear-log-detail-polish.js?v=phase3-dev3-layout21','v13.25-phase3-journal-row-polish2.js?v=phase3-dev3-layout21','v13.25-phase3-wear-log-interaction-fixes.js?v=phase3-dev3-layout21','v13.25-phase3-journal-editor-layout.js?v=phase3-dev3-layout21','v13.25-phase3-journal-editor-refinements.js?v=phase3-dev3-layout21','photo-studio-reopen-snapshot-hotfix-v13.24.js?v=phase3-dev3-layout21','photo-studio-state-integrity-hotfix-v13.24.js?v=phase3-dev3-layout21']
for token in checks:
