...
text = text.replace('</head>', style + '  <meta name="audrey-preview-build" content="v13.25-phase3-dev3-layout7">\n</head>', 1)
...
markers = (
    '<script src="./v13.25-phase1-journal-board.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./v13.25-phase2-closet-log.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./v13.25-phase3-contextual-journal.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./v13.25-phase3-era-foundation.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./v13.25-phase3-dev3-journal-experience.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./v13.25-phase3-dev3-functional-fixes.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./v13.25-phase3-dev3-journal-layout.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./v13.25-phase3-dev3-reader-polish-fix.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./v13.25-phase3-journal-title-log.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./photo-studio-reopen-snapshot-hotfix-v13.24.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./photo-studio-state-integrity-hotfix-v13.24.js?v=phase3-dev3-layout7"></script>\n'
    '  <script src="./v13.25-item-studio-context-fix.js?v=phase3-dev3-layout7"></script>'
)
...
checks = [
    'Add to Outfit Board',
    'audrey-preview-build" content="v13.25-phase3-dev3-layout7',
    'v13.25-phase1-journal-board.js?v=phase3-dev3-layout7',
    'v13.25-phase2-closet-log.js?v=phase3-dev3-layout7',
    'v13.25-phase3-contextual-journal.js?v=phase3-dev3-layout7',
    'v13.25-phase3-era-foundation.js?v=phase3-dev3-layout7',
    'v13.25-phase3-dev3-journal-experience.js?v=phase3-dev3-layout7',
    'v13.25-phase3-dev3-functional-fixes.js?v=phase3-dev3-layout7',
    'v13.25-phase3-dev3-journal-layout.js?v=phase3-dev3-layout7',
    'v13.25-phase3-dev3-reader-polish-fix.js?v=phase3-dev3-layout7',
    'v13.25-phase3-journal-title-log.js?v=phase3-dev3-layout7',
    'photo-studio-reopen-snapshot-hotfix-v13.24.js?v=phase3-dev3-layout7',
    'photo-studio-state-integrity-hotfix-v13.24.js?v=phase3-dev3-layout7',
    'v13.25-item-studio-context-fix.js?v=phase3-dev3-layout7',
]
for token in checks:
