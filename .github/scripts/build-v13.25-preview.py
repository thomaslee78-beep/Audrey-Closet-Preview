...
text = text.replace('</head>', style + '  <meta name="audrey-preview-build" content="v13.25-phase2-dev10">\n</head>', 1)
...
# Important order: core app -> reopen hotfix -> identity guard.
# The identity guard must be outermost so it synchronizes the exact item before
# the reopen hotfix decides which image/state to restore.
markers = (
    '<script src="./v13.25-phase1-journal-board.js?v=phase2-dev10"></script>\n'
    '  <script src="./v13.25-phase2-closet-log.js?v=phase2-dev10"></script>\n'
    '  <script src="./photo-studio-reopen-snapshot-hotfix-v13.24.js?v=phase2-dev10"></script>\n'
    '  <script src="./v13.25-item-studio-context-fix.js?v=phase2-dev10"></script>'
)
...
checks = [
    'Add to Outfit Board',
    'audrey-preview-build" content="v13.25-phase2-dev10',
    'v13.25-phase1-journal-board.js?v=phase2-dev10',
    'v13.25-phase2-closet-log.js?v=phase2-dev10',
    'photo-studio-reopen-snapshot-hotfix-v13.24.js?v=phase2-dev10',
    'v13.25-item-studio-context-fix.js?v=phase2-dev10',
]
for token in checks:
    if token not in text:
        raise SystemExit(f'Missing expected preview token: {token}')
if text.index('photo-studio-reopen-snapshot-hotfix-v13.24.js?v=phase2-dev10') > text.index('v13.25-item-studio-context-fix.js?v=phase2-dev10'):
    raise SystemExit('Photo Studio script order is incorrect')
