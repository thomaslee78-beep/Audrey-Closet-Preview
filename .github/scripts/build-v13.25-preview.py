...
text = text.replace('</head>', style + '  <meta name="audrey-preview-build" content="v13.25-phase4-layout60">\n</head>', 1)
...
markers='\n'.join('  <script src="./'+name+'?v=phase4-layout60"></script>' for name in names)
text = text.replace('</body>', cleanup + markers + '\n</body>', 1)
path.write_text(text, encoding='utf-8')

checks=['Add to Outfit Board','audrey-preview-build" content="v13.25-phase4-layout60','v13.25-phase3-journal-layout-hardening.js?v=phase4-layout60','v13.25-phase3-journal-sticker-surface-v2.js?v=phase4-layout60','v13.25-phase3-journal-done-exit-fix.js?v=phase4-layout60','v13.25-phase4-context-enrichment.js?v=phase4-layout60','v13.25-phase3-journal-row-final.js?v=phase4-layout60','v13.25-phase3-journal-reader-refinements.js?v=phase4-layout60']
for token in checks:
