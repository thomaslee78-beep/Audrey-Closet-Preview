/* Audrey Closet v13.22-dev15 — remove Shapes information panel */
(function(){
  'use strict';
  ...
  function installShapeStudioLayoutV132207(){
    ...
    document.getElementById('shapeStudioInfoV132207')?.remove();
  ...
  function installStylesV132207(){
    ...
    style.textContent=`
      ...
      .screen[data-screen="outfits"] #shapeStudioInfoV132207{display:none!important}
