/* Audrey Closet v13.22-dev16 — robustly remove all Shapes information panels */
(function(){
  'use strict';
  ...
  const shapePanelObserverV132216=new MutationObserver(()=>removeAllShapeInfoV132216());
