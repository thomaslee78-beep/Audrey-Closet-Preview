/* Audrey Closet v13.22-dev24 — structurally remove Text Studio editing info row */
(function(){
  'use strict';
  ...
  const textPanelObserverV132224=new MutationObserver(()=>removeTextStudioInfoV132224());
