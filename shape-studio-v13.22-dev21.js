/* Audrey Closet v13.22-dev21 — compact Decorate Text Studio controls */
(function(){
  'use strict';
  ...
  function installStylesV132207(){
    ...
    style.textContent=`
      ...
      .screen[data-screen="outfits"] .decorate-studio-panel[data-decorate-group="text"] .text-entry-action-row #boardTextInput{height:64px!important;min-height:64px!important;max-height:64px!important;padding:7px 9px!important;font-size:14px!important;line-height:1.25!important}
      ...
      .screen[data-screen="outfits"] .decorate-studio-panel[data-decorate-group="text"] .text-font-select{height:32px!important;padding:0 7px!important;font-size:12px!important;border-radius:9px!important}
